...
uint8_t MPU6050::dmpGetGravity(int16_t *data, const uint8_t* packet) {
    ...
    int16_t qI[4];
    uint8_t status = dmpGetQuaternion(qI, packet);
    data[0] = ((int32_t)qI[1] * qI[3] - (int32_t)qI[0] * qI[2]) / (int32_t)16384;
    data[1] = ((int32_t)qI[0] * qI[1] + (int32_t)qI[2] * qI[3]) / (int32_t)16384;
    data[2] = ((int32_t)qI[0] * qI[0] - (int32_t)qI[1] * qI[1]
         - (int32_t)qI[2] * qI[2] + (int32_t)qI[3] * qI[3]) / (2 * (int32_t)16384);
    return status;
}
